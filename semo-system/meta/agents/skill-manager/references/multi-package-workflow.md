...
| 접두사 | 대상 | 예시 |
|--------|------|------|
| `[po]` | semo-po 패키지만 | `[po] 새 Skill 추가해줘` |
| `[next]` | semo-next 패키지만 | `[next] Skill 수정해줘` |
| `[core]` | semo-core 패키지만 | `[core] 규칙 추가해줘` |
| `[meta]` | semo-meta 패키지만 | `[meta] Skill 삭제해줘` |
...
| 패키지 | skills/ 경로 |
|--------|-------------|
| semo-po | `semo-po/skills/` |
| semo-next | `semo-next/skills/` |
| semo-meta | `semo-meta/skills/` |
| semo-core | `semo-core/` (skills 없음) |
...
```markdown
[SEMO] Agent: skill-manager 호출 - Multi-Package Skill 생성
...
[SEMO] Agent: skill-manager 호출 - Skill 생성

✅ semo-po/skills/{skill-name}/SKILL.md 생성 완료
...
✅ semo-next/skills/{skill-name}/SKILL.md 생성 완료
...
**생성된 파일**:
- `semo-po/skills/{skill-name}/SKILL.md`
- `semo-next/skills/{skill-name}/SKILL.md`
```
...
**실패**:
- semo-next: ❌ 에러 (이미 동일 이름의 Skill 존재)
...
| 패키지 | 차이점 |
|--------|--------|
| semo-po | `--repo semicolon-devteam/semo-po`, 라벨 `semo-po` |
| semo-next | `--repo semicolon-devteam/semo-next`, 라벨 `semo-next` |
| semo-meta | `--repo semicolon-devteam/semo-meta`, 라벨 `semo-meta` |
