...
### Step 3: Projects #1 연동 + Issue Type/우선순위 설정 (필수)
...
# 3. 🔴 GitHub Issue Type을 "Bug"로 설정 (필수)
...
> **GitHub Issue Type**: Bug(`IT_kwDOC01-Rc4BdOuc`), Task(`IT_kwDOC01-Rc4BdOub`), Epic(`IT_kwDOC01-Rc4BvVz5`), Feature(`IT_kwDOC01-Rc4BdOud`)
>
