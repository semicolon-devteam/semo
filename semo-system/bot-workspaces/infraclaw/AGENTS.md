...
## 🏷️ GitHub 운영 규칙 (2026-02-19 통합)

**→ `memory/github-rules.md` 참조**

이슈 생성 체크리스트, 프로젝트 보드 등록, 라벨 전환, OAT 설정, 작업 추적 로그, 변경 통제 등 모든 규칙.

**핵심만 기억:** 이슈 생성 시 `bot:*` 라벨 + `gh project item-add 1 --owner semicolon-devteam --url <이슈URL>` 필수!
