...
7. ✅ P1-1  마이그레이션 시스템            — 완료 (semo db migrate, packages/cli/src/commands/db.ts + migrations/001~112)
8. ✅ P1-2  인덱스 추가                    — 완료 (migrations/002_add_indexes.sql)
9. ✅ P1-3  FK 추가                        — 완료 (migrations/003_add_fk.sql)
10. ✅ P0-3 session_count 트리거           — 완료 (migrations/004_session_count_trigger.sql)
11. ⬜ P1-5 KB 변경 이력                   (4시간, P1-1 의존 — knowledge_base_history 테이블 + 트리거 미구현)
