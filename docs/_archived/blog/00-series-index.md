...
| **9** | [원격 제어 - 모바일에서 Claude Code를 다루다](./09-remote-control.md) | SEMO Remote, Auto-Command, PWA |
| **10** | [가상 오피스 - AI Agent들의 협업 공간](./10-virtual-office.md) | SEMO Office, 멀티에이전트, Worktree |
