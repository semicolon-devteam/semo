...
**제목**: {issue_title}
**유형**: {bug/enhancement}
**대상 저장소**: semicolon-devteam/sax-po
...
**이슈**: semicolon-devteam/sax-po#{issue_number}
**제목**: {issue_title}
**유형**: {버그/제안}
**URL**: https://github.com/semicolon-devteam/sax-po/issues/{issue_number}
...
**대안**:
1. 수동으로 이슈 생성: https://github.com/semicolon-devteam/sax-po/issues/new
2. 나중에 다시 시도
