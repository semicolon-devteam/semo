...
| 기존 패키지 | 기존 스킬 | 새 위치 |
|-------------|----------|---------|
| sax-next | implement | coder/implement (platform: nextjs) |
| sax-backend | implement | coder/implement (platform: spring) |
| sax-mvp | implement-mvp | coder/implement (platform: mvp) |
| sax-next | scaffold-domain | coder/scaffold |
| sax-next | typescript-review | coder/review |
| sax-next | verify-implementation | coder/verify |
