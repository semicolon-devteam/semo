...
## 🔴 구현 완료 후 Quality Gate 자동 실행 (NON-NEGOTIABLE)

> **⚠️ v0.4.x Phase 완료 후 반드시 Quality Gate 실행**
...
| 조건 | 제안 |
|------|------|
| 모든 Phase 완료 + Quality Gate 통과 | A. 자가 리뷰 (권장) |
| 일부 테스트 실패 | 테스트 수정 먼저 안내 |
| Lint/TypeScript 에러 | **커밋 차단** + 에러 수정 안내 |
