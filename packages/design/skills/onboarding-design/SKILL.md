...
description: |
  디자이너 온보딩 실습 (SEMO-Design 패키지 전용). Use when (1) semo-core/skill:onboarding에서 호출,
  (2) 디자이너 온보딩 실습 필요 시. Figma + MCP 연동 및 디자인 워크플로우 체험.
tools: [Read, Bash, Glob, Grep]
model: inherit
---

> **시스템 메시지**: `[SEMO] Skill: onboarding-design 호출`

# onboarding-design Skill

> 디자이너를 위한 온보딩 실습 (SEMO-Design 패키지 전용)
...
```markdown
[SEMO] Skill: onboarding-design 호출
...
[SEMO] Skill: onboarding-design 완료
```
