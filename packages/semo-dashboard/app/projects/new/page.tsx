...
export default function ServiceNewProjectPage() {
  ...
  const [preset, setPreset] = useState<ServicePresetId>('parallel');
  ...
  function handleBasicsNext(e: React.FormEvent) {
    ...
    if (preset === 'infra-ready' && (!infraForm.repo_url.trim() || !infraForm.live_url.trim()))
      return;
        ...
        <div className="flex items-center justify-end gap-3 pt-2">
          ...
          <button
            ...
            disabled={
              ...
              (preset === 'infra-ready' &&
                (!infraForm.repo_url.trim() || !infraForm.live_url.trim()))
            }
