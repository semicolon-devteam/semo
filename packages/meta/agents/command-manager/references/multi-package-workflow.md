...
| 접두사 | 대상 | 예시 |
|--------|------|------|
| `[po]` | sax-po 패키지만 | `[po] 새 Command 추가해줘` |
| `[next]` | sax-next 패키지만 | `[next] Command 수정해줘` |
| `[core]` | sax-core 패키지만 | `[core] 규칙 추가해줘` |
| `[meta]` | sax-meta 패키지만 | `[meta] Command 삭제해줘` |
...
| 패키지 | commands/ 경로 |
|--------|---------------|
| sax-po | `sax-po/commands/` |
| sax-next | `sax-next/commands/` |
| sax-meta | `sax-meta/commands/` |
| sax-core | `sax-core/` (commands 없음) |
...
```markdown
[SAX] Agent: command-manager 호출 - Multi-Package Command 생성
...
[SAX] Agent: command-manager 호출 - Command 생성

✅ sax-po/commands/{command-name}.md 생성 완료
...
✅ sax-next/commands/{command-name}.md 생성 완료
...
**생성된 파일**:
- `sax-po/commands/{command-name}.md`
- `sax-next/commands/{command-name}.md`
```
...
**실패**:
- sax-next: ❌ 에러 (이미 동일 이름의 Command 존재)
...
| 패키지 | 차이점 |
|--------|--------|
| sax-po | `skill:sax-help` → SAX-PO 도움말 |
| sax-next | `skill:sax-help` → SAX-Next 도움말 |
| sax-meta | `skill:sax-help` → SAX-Meta 도움말 |
...
- sax-po: `skill:sax-help` (기본값)
- sax-next: `skill:sax-help` (기본값)
