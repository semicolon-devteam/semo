#!/usr/bin/env python3
"""
SAX Skill Validator - Quick validation for skill structure

Usage:
    quick_validate.py <skill-directory>

Examples:
    quick_validate.py sax-next/skills/health-check
    quick_validate.py sax-po/skills/epic-master
"""
...
def validate_skill(skill_path):
    """Validate a SAX skill structure."""
    ...
    if description:
        ...
        # SAX-specific: check for "when to use"
    ...
    # Check SAX Message section
    if '[SAX] Skill:' not in content:
        warnings.append("Missing SAX Message section")
...
def main():
    if len(sys.argv) != 2:
        ...
        print("\nExamples:")
        print("  quick_validate.py sax-next/skills/health-check")
        print("  quick_validate.py sax-po/skills/epic-master")
        sys.exit(1)
