...
const SERVICES: ServiceDef[] = [
  ...
  { name: 'gameland', status: 'active', originalKey: 'gameland', botKeys: ['game-land/semiclaw'] },
  {
    name: 'jungchipan',
    status: 'active',
    originalKey: 'jungchipan',
    botKeys: ['jungchipan/semiclaw'],
  },
  ...
  { name: 'ps', status: 'active', originalKey: 'ps', botKeys: ['ps/semiclaw'] },
  {
    name: 'star-spot',
    status: 'active',
    originalKey: 'star-spot',
    botKeys: [
      'star-spot/semiclaw',
      'star-spot/planclaw',
      'star-spot/workclaw',
      'star-spot/growthclaw',
    ],
  },
  {
    name: 'labor-union',
    status: 'active',
    originalKey: 'labor-union',
    botKeys: ['labor-union/semiclaw'],
  },
  { name: 'viral', status: 'active', originalKey: 'viral', botKeys: [] },
  {
    name: 'office-community',
    status: 'active',
    originalKey: 'office-community',
    botKeys: ['office-land/semiclaw'],
  },
  {
    name: 'core-backend',
    status: 'active',
    originalKey: 'core-backend',
    botKeys: ['core-backend-context/semiclaw'],
  },
  { name: 'linkta', status: 'active', originalKey: 'linkta', botKeys: [] },
  {
    name: 'sales-keeper',
    status: 'active',
    originalKey: 'sales-keeper',
    botKeys: ['sales-keeper/semiclaw'],
  },
  ...
  { name: 'introduction', status: 'maintenance', originalKey: 'introduction', botKeys: [] },
  {
    ...
    status: 'active',
    originalKey: 'semo',
    botKeys: ['semo/semiclaw', 'semo/planclaw'],
  },
...
async function main() {
  ...
  try {
    ...
    const keysToDelete = [...META_KEYS, ...SERVICES.flatMap((s) => [s.originalKey, ...s.botKeys])];
    ...
    const totalEntries = await client.query('SELECT COUNT(*)::int as cnt FROM semo.knowledge_base');
