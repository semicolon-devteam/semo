...
| **필수 필드 누락** | Issue Type, 우선순위 등 필수 속성 미설정 |
...
| 필드 | 필수 여부 | 설명 |
|------|----------|------|
| **Issue Type** | ✅ 필수 | Epic, Bug, Task, Feature 중 선택 |
| **우선순위** | ✅ 필수 | P0~P4 중 선택 |
| **Status** | ✅ 필수 | 워크플로우 상태 |
...
4. Task 이슈에 작업량 할당 → **`set-estimate` Skill 사용**
```
